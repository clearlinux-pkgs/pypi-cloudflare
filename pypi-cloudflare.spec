...
Source0  : https://files.pythonhosted.org/packages/28/1d/45eeb18ad2d801d1f460bee30eef6ff1ec087ac587c3449650b182337d0d/cloudflare-3.0.1.tar.gz
...
%prep
%setup -q -n cloudflare-3.0.1
cd %{_builddir}/cloudflare-3.0.1
pushd ..
cp -a cloudflare-3.0.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719329198
