...
Version  : 4.1.0
Release  : 62
URL      : https://files.pythonhosted.org/packages/14/3c/52a4246ec925bf0133d89a151a0258b40a407a576538b648c2afa210831e/cloudflare-4.1.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/14/3c/52a4246ec925bf0133d89a151a0258b40a407a576538b648c2afa210831e/cloudflare-4.1.0.tar.gz
...
%prep
%setup -q -n cloudflare-4.1.0
cd %{_builddir}/cloudflare-4.1.0
pushd ..
cp -a cloudflare-4.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742433677
