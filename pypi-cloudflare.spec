...
Version  : 2.15.1
Release  : 47
URL      : https://files.pythonhosted.org/packages/7f/8a/8be7bf240769735d1d407cec5cce935624239db68ee3d70990603ffea569/cloudflare-2.15.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/7f/8a/8be7bf240769735d1d407cec5cce935624239db68ee3d70990603ffea569/cloudflare-2.15.1.tar.gz
...
%prep
%setup -q -n cloudflare-2.15.1
cd %{_builddir}/cloudflare-2.15.1
pushd ..
cp -a cloudflare-2.15.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703866835
