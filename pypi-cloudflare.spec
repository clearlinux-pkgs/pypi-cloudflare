...
Version  : 3.1.1
Release  : 59
URL      : https://files.pythonhosted.org/packages/d4/61/ab3f3c1ad6789df41b71a432dbc3bbd957cc58ba07dd676fdad2d76018f6/cloudflare-3.1.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/d4/61/ab3f3c1ad6789df41b71a432dbc3bbd957cc58ba07dd676fdad2d76018f6/cloudflare-3.1.1.tar.gz
...
%prep
%setup -q -n cloudflare-3.1.1
cd %{_builddir}/cloudflare-3.1.1
pushd ..
cp -a cloudflare-3.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1733321174
...
cp %{_builddir}/cloudflare-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-cloudflare/d4bc943806b1f7d40fe8b913e135024dbb0af400 || :
...
/usr/share/package-licenses/pypi-cloudflare/d4bc943806b1f7d40fe8b913e135024dbb0af400
