...
Version  : 2.17.0
Release  : 49
URL      : https://files.pythonhosted.org/packages/3e/b4/78a3ee7e19dde2ed000ee92cb6c368fa837c7c9140b769b82fca3c0e9c38/cloudflare-2.17.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/3e/b4/78a3ee7e19dde2ed000ee92cb6c368fa837c7c9140b769b82fca3c0e9c38/cloudflare-2.17.0.tar.gz
...
%prep
%setup -q -n cloudflare-2.17.0
cd %{_builddir}/cloudflare-2.17.0
pushd ..
cp -a cloudflare-2.17.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705971460
